...
const Footer = () => {
    return (
        <footer className="fixed top-0  z-[-1] w-full">
            ...
            <div className="flex flex-col items-center gap-y-10 absolute top-2/4 left-2/4 -translate-y-2/4 -translate-x-2/4 w-[60%]">
                <div>
                    <h3 className="text-footerHeadingFontSize font-footerHeadingFontWeight leading-footerHeadingLineHeight flex flex-wrap gap-x-20 items-center justify-between">
                        <span>SUBSCRIBE</span>
                ...
                <div>
                    <form className="flex">
                        <div className="border-y-2 border-l-2 w-64 p-2">
                            <input className="bg-transparent focus:outline-none placeholder-black" type="email" placeholder="Your Email" />
                        </div>
                        <motion.button className="sectionHeadAnchor cursor-pointer relative overflow-hidden flex justify-around items-center w-44 h-12 border-2"
                            whileHover={{
                                color: "white",
                                borderColor: "black",
            ...
            <div className="absolute bottom-0 px-4 pb-4 flex justify-between items-end w-full">
                <div>
