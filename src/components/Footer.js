...
const Footer = () => {
    return (
        <footer className="fixed top-0  z-[-1]  w-full">
            <div className="h-screen w-full">
                <video className="h-full w-full" style={{ objectFit: "cover" }} autoplay="true" loop="true" muted="true">
            ...
            <div id="footer-main-div" className="flex flex-col items-center gap-y-[5vh] absolute top-[43vh] left-2/4 sssm:w-[90%] md:w-[60%]">
                <div>
                    <h3 className="sssm:text-footerHeadingFontSizeSssm md:text-footerHeadingFontSize font-footerHeadingFontWeight leading-footerHeadingLineHeight flex flex-wrap sssm:gap-x-5 md:gap-x-20 items-center justify-between">
                        <span>SUBSCRIBE</span>
                ...
                <div>
                    <form className="flex">
                        <div className="border-y-2 border-l-2 sssm:w-56 md:w-64 p-2">
                            <input className="bg-transparent focus:outline-none placeholder-black" type="email" placeholder="Your Email" />
                        </div>
                        <motion.button className="sectionHeadAnchor cursor-pointer relative overflow-hidden flex justify-around items-center sssm:w-28 md:w-44 h-12 border-2"
                            whileHover={{
                                color: "white",
                                borderColor: "black",
            ...
            <div className="absolute bottom-0 px-4 pb-4 flex justify-between items-end w-full sssm:text-footerCopyrightFontSizeSssm md:text-footerCopyrightFontSize">
                <div>
                    <p>&copy; 2024 Collage Studio</p>
                </div>
                <div className=" w-[10%]">
