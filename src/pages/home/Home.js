...
const Home = () => {
    return (
        <div>
            ...
            <section className="px-[6vw] mb-28">
            ...
            <section className="px-[6vw]">
                <article className="">
                    ...
                    <div className="flex justify-between w-full mb-20">
                        <div>
                            <h3 className="text-productSectionHeadingFontSize font-productSectionHeadingFontWeight">ABOUT</h3>
                        </div>
                        <div className="w-2/4 pt-6 text-aboutSectionPFontSize">
                            <p className="mb-6">
                    ...
                    <div className="flex justify-between">
                        ...
                        <div className="flex justify-between text-aboutSectionPFontSizeTwo font-productHeadingAnchorFontWeight w-2/4">
                            <p className="w-[48%]">
