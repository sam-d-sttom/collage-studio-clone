                    ...
                    <div className="flex justify-between sssm:flex-col md:flex-row w-full mb-20">
                        ...
                        <div className="sssm:w-full md:w-2/4 pt-6 sssm:text-aboutSectionPFontSizeSssm md:text-aboutSectionPFontSize">
                            ...
                            <div className="flex items-end justify-end">
                                ...
                                <span className="text-devNameFontSize">Oyebanji Oluwatomisin<br />Software Engineer</span>
                            </div>
                        </div>
                    </div>

                    <div className="flex justify-between sssm:gap-y-20 md:gap-y-0 sssm:flex-col md:flex-row">
                        <div className="flex flex-col sssm:w-[90%] md:w-2/6">
                            <div className="flex mb-16 justify-between">
                                <div className="font-logoFontWeight text-secondaryFontSize">FEATURED</div>
                                <div>
                                    <ul>
                                        <li className="font-logoFontWeight text-primaryFontSize leading-secondaryLineHeight">Châtelaine</li>
                                        <li className="font-logoFontWeight text-primaryFontSize leading-secondaryLineHeight">Design Montréal</li>
                                        <li className="font-logoFontWeight text-primaryFontSize leading-secondaryLineHeight">La Presse</li>
                                        <li className="font-logoFontWeight text-primaryFontSize leading-secondaryLineHeight">Les idées de ma maison</li>
                                        <li className="font-logoFontWeight text-primaryFontSize leading-secondaryLineHeight">Le Cahier</li>
                                        <li className="font-logoFontWeight text-primaryFontSize leading-secondaryLineHeight">Magazine Ligne</li>
                                        <li className="font-logoFontWeight text-primaryFontSize leading-secondaryLineHeight">Style at Home</li>
                                        <li className="font-logoFontWeight text-primaryFontSize leading-secondaryLineHeight">Souk</li>
                                    </ul>
                                </div>
                            </div>
                            <div className="flex justify-between">
                                <div className="font-logoFontWeight text-secondaryFontSize">BOUTIQUES</div>
                                <div>
                                    <ul>
                                        <li className="font-logoFontWeight text-primaryFontSize leading-secondaryLineHeight">Boutique Arloca</li>
                                        <li className="font-logoFontWeight text-primaryFontSize leading-secondaryLineHeight">Bouche Bée</li>
                                        <li className="font-logoFontWeight text-primaryFontSize leading-secondaryLineHeight">Espace Flo</li>
                                        <li className="font-logoFontWeight text-primaryFontSize leading-secondaryLineHeight">Femme Mécanique</li>
                                        <li className="font-logoFontWeight text-primaryFontSize leading-secondaryLineHeight">Gypsie Bohème</li>
                                        <li className="font-logoFontWeight text-primaryFontSize leading-secondaryLineHeight">Josephine</li>
                                        <li className="font-logoFontWeight text-primaryFontSize leading-secondaryLineHeight">L'empreinte Cooperative</li>
                                        <li className="font-logoFontWeight text-primaryFontSize leading-secondaryLineHeight">The Collective Good</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="flex justify-between sssm:flex-col md:flex-row sssm:gap-y-10 md:gap-y-0 text-aboutSectionPFontSizeTwo font-productHeadingAnchorFontWeight sssm:w-full md:w-2/4">
                            <p className="sssm:w-full md:w-[48%]">
                                Collage is a contemporary product design boutique that creates original and unique pieces, experimenting with different materials, shapes, textures and colors. We create a wide variety of hand-crafted objects, from decorative and utility accessories to jewelry, while constantly evolving to offer unique products for a design-savvy clientele
                            </p>
                            <p className="sssm:w-full md:w-[48%]">
                                We pride ourselves in providing a personal approach and one-of-a-kind customer experience while still providing solid value to all our clients. With our unique designs and timeless appeal, we are able to capture the attention of any client.
                            </p>
                        </div>
                    </div>
                </article>
